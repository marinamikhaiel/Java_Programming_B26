...
public class Store_TestFood {
    ...
    public static void main(String[] args) {
        ...
        allFood[3]=new Food("Pizza", 4, 3.55); // making a new Food object assigning it into the array in index 3
        ...
        for (Food each: allFood){ // each== allFood[i] // why is Food the first thing in the for each- it is the datatype of each elemnet
