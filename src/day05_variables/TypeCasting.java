...
public class TypeCasting {
    public static void main(String[] args) {
        ...
        byte b=40;
        int i=b; // the byte value is automatically converted to int bec byte is smaller than int
        ...
        int i3=500;
        long l1= (long)i3; // int is smaller than long, so it will automatically cast
