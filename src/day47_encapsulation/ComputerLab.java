...
public class ComputerLab {
    public static void main(String[] args) {
      ...
      Computer.hasBattery= false;
        ...
        //System.out.println(Computer.brand);// this is not possible because brand is an instance variable and we are trying to access by the class name, but  we need an object
