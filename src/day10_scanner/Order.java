 ...
 */
        ...
        input.nextLine();// transition from any next to nextLine

        System.out.println( " What is the full name for the order");
        String fullName= input.nextLine();
        double totalCost = price*quantity;

        System.out.println(fullName+", your order for "+ quantity + " "+productName+ "s has been placed. Your total is $" +totalCost);
