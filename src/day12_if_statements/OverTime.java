...
and 3 hours overtime pay)
        ...
        if ( numberOfHours > 40){
            // when the number of hours more than 40, we will get an extra 1.5 for overtime pay
            ...
            // when the number of hours is less than or equal to 40, we will run this cpde
