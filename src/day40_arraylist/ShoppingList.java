...
public class ShoppingList {
    ...
    do {
        ...
        if(input.nextLine().equals("yes")){
            ...
            String removeItem= input.nextLine(); // this will either be an item name or item number
            ...
            if (Character.isDigit((removeItem.charAt(0)))) {// checks the first character of remove item, checks if it is a number
                ...
                shoppingList.remove(number - 1);// converts tghe number to an index. if the user wants to remove the first item, they would give 1, so to remove the first index 1-1=0
            }else {
