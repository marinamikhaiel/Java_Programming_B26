...
public class JobTitles {
    public static void main(String[] args) {
        ...
        System.out.println("Remove: "+jobs1);

        ArrayList<String> jobs2= new ArrayList<>(allJobs);
        jobs2.retainAll(Arrays.asList("SDET", "Developer", "Dev op", "PO"));
        System.out.println("Retain: "+jobs2);

        ArrayList<String> jobs3= new ArrayList<>(allJobs);
        System.out.println("Contain: "+jobs3.containsAll(Arrays.asList("CEO", "Chef")));// case sensitive
        System.out.println("Contain: "+jobs3.containsAll(Arrays.asList("Doctor", "Nurse")));
    }
